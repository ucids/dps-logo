    ...
    <div class="card h-md-100">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold text-gray-900">¿Qué hay para hoy?</span>

                <span class="text-muted mt-1 fw-semibold fs-7">Juntas</span>
            </h3>
            ...
            <ul class="nav nav-stretch nav-pills nav-pills-custom nav-pills-active-custom d-flex justify-content-between mb-8 px-5"
                ...
                <li class="nav-item p-0 ms-0" role="presentation">
                    ...
                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger"
                        data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_2" aria-selected="false" role="tab"
                        tabindex="-1">
                ...
                <li class="nav-item p-0 ms-0" role="presentation">
                    <!--begin::Date-->
                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger"
                        data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_3" aria-selected="false" role="tab"
                        tabindex="-1">
                ...
                <li class="nav-item p-0 ms-0" role="presentation">
                    <!--begin::Date-->
                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger"
                        data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_4" aria-selected="false" role="tab"
                        tabindex="-1">
                ...
                <li class="nav-item p-0 ms-0" role="presentation">
                    <!--begin::Date-->
                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger"
                        data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_5" aria-selected="false" role="tab"
                        tabindex="-1">
                        <span class="fs-7 fw-semibold">Tu</span>
                ...
                <li class="nav-item p-0 ms-0" role="presentation">
                    <!--begin::Date-->
                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger"
                        data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_8" aria-selected="false" role="tab"
                        tabindex="-1">
                ...
                <li class="nav-item p-0 ms-0" role="presentation">
                    <!--begin::Date-->
                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger"
                        data-bs-toggle="tab" href="#kt_timeline_widget_3_tab_content_9" aria-selected="false" role="tab"
                        tabindex="-1">
                        <span class="fs-7 fw-semibold">Sa</span>
    ...
    <div class="card card-flush d-none h-md-100">
        ...
        <div class="card-header mt-6">
            ...
            <div class="card-toolbar">
                ...
                <select name="status" data-control="select2" data-hide-search="true"
                    ...
                    data-select2-id="select2-data-7-d3eh" tabindex="-1" aria-hidden="true" data-kt-initialized="1">
                    <option value="1" selected="" data-select2-id="select2-data-9-ri72">Options</option>
                    <option value="2">Option 1</option>
                    <option value="3">Option 2</option>
                    <option value="4">Option 3</option>
                </select><span class="select2 select2-container select2-container--bootstrap5" dir="ltr"
                    data-select2-id="select2-data-8-0ocs" style="width: 100%;"><span class="selection"><span
                            ...
                            aria-disabled="false" aria-labelledby="select2-status-qg-container"
                            aria-controls="select2-status-qg-container"><span class="select2-selection__rendered"
                                id="select2-status-qg-container" role="textbox" aria-readonly="true"
        ...
        <div class="card-body p-0">
            ...
            <ul class="nav nav-pills d-flex flex-nowrap hover-scroll-x py-2 ms-4" role="tablist">
                ...
                <li class="nav-item me-1" role="presentation">
                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px me-2 py-4 px-3 btn-color-active-white btn-active-danger "
                        data-bs-toggle="tab" href="#kt_schedule_day_1" aria-selected="false" tabindex="-1" role="tab">
                ...
                <li class="nav-item me-1" role="presentation">
                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px me-2 py-4 px-3 btn-color-active-white btn-active-danger "
                        data-bs-toggle="tab" href="#kt_schedule_day_11" aria-selected="false" tabindex="-1" role="tab">
